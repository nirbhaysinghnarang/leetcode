...
class Solution:
    def buildTree(self, preorder: List[int], inorder: List[int]) -> Optional[TreeNode]:
        ...
        print(left_children_in_inorder)
        right_children_in_inorder = inorder[root_index_in_inorder+1:]
        print(right_children_in_inorder)
        left_children_in_preorder = preorder[1:len(left_children_in_inorder)]
        print(left_children_in_preorder)
        right_children_in_preorder = preorder[len(left_children_in_inorder)+1:]
        print(right_children_in_preorder)
